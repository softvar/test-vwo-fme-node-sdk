...
import { SAMPLED_DEBUG_ERROR_TEMPLATE_KEYS } from '../constants/SampledDebugErrorTemplateKeys.js';
/**
 ...
 */
export function wasSdkInitializedEarlier(settings = {}) {
 ...
 */
export function getInternalEventsRuntimeKey() {
 ...
 */
export function getDefaultSamplingPercent(runtimeKey) {
 ...
 */
export function normalizeSamplingPercent(samplingValue, runtimeKey) {
 ...
 */
export function getRuntimeSamplingPercent(runtimeSamplingConfig, runtimeKey) {
 ...
 */
export function getUsageStatsSamplingPercent(settings = {}) {
    const usageSamplingConfig = settings?.[Constants.INTERNAL_EVENTS_SAMPLING_KEY]?.[Constants.INTERNAL_EVENTS_USAGE_SAMPLING_KEY];
 ...
 */
export function getDebugEventSamplingPercent(settings = {}) {
    const debugSamplingConfig = settings?.[Constants.INTERNAL_EVENTS_SAMPLING_KEY]?.[Constants.INTERNAL_EVENTS_DEBUG_SAMPLING_KEY];
 ...
 */
export function shouldApplyEventSampling(settings = {}) {
 ...
 */
export function passesSamplingPercent(samplingPercent, randomValue = Math.random()) {
 ...
 */
export function isSampledDebugErrorTemplateKey(messageTemplateKey) {
